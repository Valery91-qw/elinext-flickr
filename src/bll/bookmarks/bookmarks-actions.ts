...
export const addImageToBookmark = createAction<{photo: ImageType, tags: Array<string>}, BookmarksEnum.ADD_IMAGE>(BookmarksEnum.ADD_IMAGE)

export const removeImageToBookmark = createAction<{bookmarkId: string}, BookmarksEnum.REMOVE_IMAGE>(BookmarksEnum.REMOVE_IMAGE)
